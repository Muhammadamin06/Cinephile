...
function Intro({ data }) {
    ...
    return animate ? (
        <section className={styles.intro}>
            <img src={`${image_url}/original${data[num].backdrop_path}`} alt="background" className={styles.intro__bg} />
            ...
            <div className={styles.intro__next} onClick={handleNext}>
                <div className={styles.intro__next_info}>
                    <img src={`${image_url}/w300${data.length <= num + 1 ? data[0].backdrop_path : data[num + 1].backdrop_path}`} alt="next movie" className={styles.intro__next_bg} />
